...
def add_train_argument(p):
    ...
    p.add_argument('--split_type',type=str,choices=['random', 'scaffold', 'ratio_random'],default='random',
    ...
    p.add_argument('--nheads',type=int,default=4,
                   help='The number of the attentions in gnn.') #几个头
    ...
    p.add_argument('--model_type',type=str,default='moleculeformer',
                   help='The type of model.') # 选择模型 v1 FP-GNN transformer FP
    p.add_argument('--noise_rate',type=float,default=0.0,
                   help='The noise_rate of model.') # 抗噪实验
    p.add_argument('--force_field',type=str,default='MMFF',
                   help='Force field optimization:NO, UFF, MMFF') # 力场优化
